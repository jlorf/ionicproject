...
const Alumnes: React.FC = () => {
  ...
  var btnClick = (alumne: Persona) => {
    globalThis.localStorage.setItem("alumne", JSON.stringify(alumne));
    window.location.replace("mod-alumne");
  };

  if ((context?.alumnes?.length ?? 0) == 0)
